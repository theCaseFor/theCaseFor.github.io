...
<html>
  ...
  <form style="background-color:#EEEEEE; width: 600px; height: 380px; margin-left: 50px;" name="input" method="POST" action="https://formspree.io/thecase4existence@gmail.com">
       Name: <input style="width: 300px; margin-left: 90px;" type="text" name="Name" placeholoder="Your name"><br><br>
       Email:  <input style="width: 300px; margin-left: 90px;" type="email" name="Name" placeholoder="Your name"><br><br>
