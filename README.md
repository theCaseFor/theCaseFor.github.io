...
<html>
  ...
  <form style="background-color:#EEEEEE; width: 600px;" name="input" method="POST" action="https://formspree.io/thecase4existence@gmail.com">
       ...
       Message: <textarea style="width: 550px; border-top: 50px; border-bottom: 50px;" name="message" placeholoder="Your name"></textArea><br>
